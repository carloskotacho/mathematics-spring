...
<head>
  ...
  <title>Geometry | Registrado com sucesso!</title>
...
<div class="login-box">
  ...
  <div class="error-page">
    <h2 class="headline text-success"> 201</h2>

    <div class="error-content">
        <h3><i class="fa fa-check text-success"></i> Oba! Registrado com sucesso.</h3>
        <p>
            Sua conta foi criada, divirta-se!
            <a href="/entrar">realizar login.</a>
        </p>
    </div>
  </div>
  <!-- /.login-box-body -->
