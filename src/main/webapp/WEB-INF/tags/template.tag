...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-lg"><b>Geometry</b>Portal</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="../resources/img/masc.jpg" class="user-image" alt="Imagem Mascote">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">${ cookie.currentUser.value }</span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="../resources/img/masc.jpg" class="img-circle" alt="Imagem Mascote">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="../resources/img/masc.jpg" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p>${ cookie.currentUser.value }</p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <sec:authorize access="hasRole('ROLE_ADMIN')">
            <li class="active"><a href="/a"><i class="fa fa-user-secret"></i> <span>Administrador</span></a></li>
        </sec:authorize>
        <sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_USER')">
            <li><a href="/u"><i class="fa fa-user"></i> <span>Usuário</span></a></li>
        </sec:authorize>
        <sec:authorize access="hasRole('ROLE_ADMIN')">
            <li class="treeview">
              <a href="#"><i class="fa fa-list-alt"></i> <span>Gerência</span>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="a/listar">Dados dos Usuários</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="/u"><i class="fa fa-dashboard"></i> Início</a></li>
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      <a href="https://github.com/carloskotacho" class="fa fa-github text-purple"></a>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; <span id="year"></span> <a href="#" class="text-purple">Carlos Kotacho</a>.</strong> Todos os direitos reservados.
  </footer>
