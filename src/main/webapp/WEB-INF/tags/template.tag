...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Carlos Kotacho</span>
            </a>
            <ul class="dropdown-menu">
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      <a href="https://github.com/carloskotacho" class="fa fa-github"></a>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; <span id="year"></span> <a href="#">Carlos Kotacho</a>.</strong> Todos os direitos reservados.
  </footer>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:;">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Aniversário de Carlos</h4>
